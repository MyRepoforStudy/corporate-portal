...
export const kk: Dictionary = {
  ...
  calendar: {
    ...
    nextMonth: "Келесі ай",
    empty: "Бұл айда жазбалар жоқ.",
    deleteHoliday: "Мерекені жою керек пе?",
    deleteVacation: "Демалыс жазбасын жою керек пе?",
    deleteFailed: "Жою мүмкін болмады",
    holidayModal: {
      title: "Жаңа мереке",
      titleLabel: "Атауы",
      titlePlaceholder: "Мысалы: Республика күні",
      dateLabel: "Күні",
      cancel: "Бас тарту",
      save: "Қосу",
      saving: "Қосылуда...",
      createFailed: "Мерекені қосу мүмкін болмады",
    },
    vacationModal: {
      title: "Жаңа демалыс",
      ...
      save: "Қосу",
      saving: "Қосылуда...",
      createFailed: "Демалысты қосу мүмкін болмады",
    },
  },
};
