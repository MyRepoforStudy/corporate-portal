export const ru = {
  ...
  documents: {
    title: "Документы",
    subtitle: "Регламенты, политики и формы банка",
    empty: "Документы пока не добавлены.",
  },
  hr: {
    title: "HR",
    subtitle: "Отпуск, ваш отдел и контакты HR",
    vacationTitle: "Отпуск",
    notLinked: "Профиль не привязан к записи сотрудника в оргструктуре. Обратитесь в HR.",
    departmentTitle: "Ваш отдел",
    contactTitle: "Контакт HR",
    contactFallback: "Обратитесь в отдел кадров.",
    quickLinksTitle: "Быстрые ссылки",
    quickLinkOrgStructure: "Оргструктура",
    quickLinkCompass: "Компас новичка",
    quickLinkBooking: "Бронирование переговорных",
    quickLinkProfile: "Личный кабинет",
  },
  itServices: {
    title: "IT-сервисы",
    subtitle: "Заявки в IT и контакт службы поддержки",
    contactTitle: "Контакт IT",
    contactFallback: "Обратитесь в IT-департамент.",
    formTitle: "Создать заявку",
    subjectPlaceholder: "Тема заявки",
    descriptionPlaceholder: "Опишите проблему или запрос",
    submit: "Отправить заявку",
    submitting: "Отправка...",
    submitSuccess: "Заявка отправлена в IT",
    submitFailed: "Не удалось отправить заявку",
    myRequestsTitle: "Мои заявки",
    myRequestsEmpty: "У вас пока нет заявок.",
    statusOpen: "В работе",
