      ...
      {isLoading ? (
        ...
        <div className="divide-y divide-gray-100 rounded-lg border border-gray-200 bg-white">
          {items.map((announcement) => (
            <div key={announcement.id} className="flex items-start justify-between gap-3 px-4 py-2.5">
              <p className="whitespace-pre-line text-sm text-gray-900">{announcement.title}</p>
